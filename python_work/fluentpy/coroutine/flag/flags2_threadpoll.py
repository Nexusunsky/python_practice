...
from fluentpy.coroutine.flag.flag_common import HTTPStatus, main
from fluentpy.coroutine.flag.flags2_sequential import download_one
...
def download_many(cc_list, base_url, verbose, concur_req):
    ...
    with futures.ThreadPoolExecutor(max_workers=concur_req) as executor:  # <6>
        ...
        done_iter = futures.as_completed(to_do_map)  # <11> 只返回已经运行结束的期物
